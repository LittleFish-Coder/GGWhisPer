...
import UploadTranscriptAndTerm from "../../component/UploadTranscriptAndTerm";
...
export default function AudioInfoPage(): ReactElement {
    ...
    return (
        <div id="audioInfoPage">
            <div className="leftSide">
                <div className="leftSideAbove">
                    <h1 className="title">{audio?.title}</h1>
                    <p className="info">{audio?.info}</p>
                </div>
                <AudioDisplay audio_id={audio?.id || 0} />
                <UploadTranscriptAndTerm audio={audio} />
            </div>
            <div className="rightSide">
                <div className="rightSideAbove">
                    <button onClick={handleSummary} className="summaryButton">
                        <MdSummarize />
                    </button>
